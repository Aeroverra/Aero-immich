...
export class DatabaseService extends BaseService {
  ...
  async onBootstrap() {
    ...
    await this.databaseRepository.withLock(DatabaseLock.Migrations, async () => {
      ...
      try {
        await this.databaseRepository.reindexVectorsIfNeeded([VectorIndex.Clip, VectorIndex.Face, VectorIndex.ClipFrame]);
      } catch (error) {
        this.logger.warn(
      ...
      preparation.push(
        ...
        this.databaseRepository.prewarm(VectorIndex.ClipFrame),
      );
