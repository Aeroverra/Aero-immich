...
AERO_GLUE_PATHS=${AERO_GLUE_PATHS:-".github/workflows/aero-release.yml .github/workflows/aero-dry-run.yml .github/workflows/aero-revert-validation.yml .github/scripts .github/aero-branches.txt docs-aero scripts/aero"}
